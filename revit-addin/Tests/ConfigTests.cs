...
public class ConfigTests : IDisposable
{
    ...
    public ConfigTests()
    {
        _tempDir = Path.Combine(Path.GetTempPath(), "buildspec-test-" + Guid.NewGuid().ToString("N"));
    ...
    {
        Config.Reset();
        Environment.SetEnvironmentVariable("BUILDSPEC_SUPABASE_URL", null);
        Environment.SetEnvironmentVariable("BUILDSPEC_API_KEY", null);
    ...
    {
        Environment.SetEnvironmentVariable("BUILDSPEC_SUPABASE_URL", "https://test.supabase.co");
    ...
    {
        Environment.SetEnvironmentVariable("BUILDSPEC_API_KEY", "test-key-123");
    ...
    public void EnvVar_TakesPrecedenceOverConfigJson()
    {
        ...
        Environment.SetEnvironmentVariable("BUILDSPEC_SUPABASE_URL", "https://env.supabase.co");
        Environment.SetEnvironmentVariable("BUILDSPEC_API_KEY", "env-key");
